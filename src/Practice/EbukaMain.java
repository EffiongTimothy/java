...
public class EbukaMain {

        private static ebukaDairy diary;
        ...
        private static void createDiary(){
            ...
            diary = new ebukaDairy(username, password);
        ...
        private static void findById() {
            ...
            EbukaEntry foundEntry = diary.findEntryWithId(Integer.parseInt(id));
